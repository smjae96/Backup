...
//			System.out.println(conn);
	...
	// 마감일 순 
	public ArrayList<Plan> selectPlan2(Connection conn, String userId) {
		ArrayList<Plan> list = new ArrayList<>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		// 마감일이 빠른 순으로 조회하도록 함!
		String sql = "SELECT * FROM PLAN WHERE WRITER = ? ORDER BY END_DATE DESC";
	...
	public ArrayList<Plan> selectPlan3(Connection conn, String userId) {
		ArrayList<Plan> list = new ArrayList<>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		// 마감일이 빠른 순으로 조회하도록 함!
		String sql = "SELECT * FROM PLAN WHERE WRITER = ? ORDER BY START_DATE ASC";
	...
	public ArrayList<Plan> selectPlan4(Connection conn, String userId) {
		ArrayList<Plan> list = new ArrayList<>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		// 마감일이 빠른 순으로 조회하도록 함!
		String sql = "SELECT * FROM PLAN WHERE WRITER = ? ORDER BY START_DATE DESC";
