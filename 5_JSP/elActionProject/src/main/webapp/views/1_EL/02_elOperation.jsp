...
<body>
	...
	기존 방식 (el 사용하지 않음) : 
 	...
 	big에 담긴 값이 10000과 일치하는지? ${ big == 10000 } 또는 ${ big eq 10000 } 또는 ${ big eq "10000" }<br>
 	...
 	* big이 small보다 크고 list1이 비어있는가? <%-- <%= (reque > small) && (list1.isEmplty()) %> --%>
 	${ (big > small) && (empty list1) } <br>
