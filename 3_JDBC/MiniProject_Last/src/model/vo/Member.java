...
public class Member {
	...
	public Member(int userNo, String userId, String userPw, String userName, String gender, String ssn, int age,
			double height, double weight, Date enrollDate) {
		super();
		this.userNo = userNo;
		this.userId = userId;
		this.userPw = userPw;
	...
	public Member(String userId, String userPw, String userName, String gender, String ssn, int age, double height,
			double weight) {
		super();
		this.userId = userId;
		this.userPw = userPw;
	...
	public String toString() {
		return "Member [userNo=" + userNo + ", userId=" + userId + ", userPw=" + userPw + ", userName=" + userName
				+ ", gender=" + gender + ", ssn=" + ssn + ", age=" + age + ", height=" + height + ", weight=" + weight
