...
%>
<%--
ArrayList<Plan> list2 = (ArrayList<Plan>) session.getAttribute("planList2");
ArrayList<Plan> list3 = (ArrayList<Plan>) session.getAttribute("planList3");
ArrayList<Plan> list4 = (ArrayList<Plan>) session.getAttribute("planList4");
