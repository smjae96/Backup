...
public class Testing {
	...
	prop2.setProperty("insertMember","INSERT INTO MEMBER VALUES(SEQ_UNO.NEXTVAL,?, ?, ?, ?, ?, ?, ?, ?, ?, SYSDATE)");
	...
	prop2.setProperty("updateMember", "UPDATE MEMBER SET USERPW = ?, EMAIL = ?, PHONE = ?, ADDRESS = ? WHERE USERID = ?");
